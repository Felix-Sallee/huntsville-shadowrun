...
slug: game-materials
kind: index
tags: [fluff, tools, resources]
created: 2026-09-23
---

# 🎲 Game Materials

Flavor text, advertisements, tables, and other supplementary materials for the Huntsville Shadowrun campaign.

---

## Advertisements & Flavor Text

| Title | Description | Link |
|-------|-------------|------|
| Commercial Cyberware Advertisement | Sprawl-wide cyberware commercial featuring canon products from Man & Machine | [Read More](commercial-cyberware-ad.html) |

## Tools & Resources

- **SR3E Character Creation Reference**: See the [NPCs directory](../NPCs/) for character examples and stat blocks
