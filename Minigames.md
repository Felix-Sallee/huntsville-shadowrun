...
# Minigames and Web Apps | Huntsville Shadowrun Campaign Wiki

Static Shadowrun apps live on GitHub Pages and use the Huntsville campaign wiki as the hub for discovery, canon links, and maintenance notes.
...
- Daniel or a maintainer validates the issue author before applying any canonical repo/wiki updates.
- Canonical changes land as commits, trigger CI/CD, and then get closed out in GitHub and Discord.

## Permission gate

Public issue creation is not permission to mutate canon. Herrick should only act on a persistence issue when the issue author's GitHub association is MEMBER, OWNER, or COLLABORATOR, or a repo member explicitly approves the request in-thread.
...
- [SR3 GM Spirit Tool](/Tools/SR3-GM-Spirit-Tool.html) - SR3 spirit and elemental calculator for Force-based attributes, attacks, initiative, powers, domains, and weaknesses.

## Huntsville workflow aids

These are player-facing table procedures, with guided web-app versions where available.

- [Matrix Searches](/Tech/Matrix/Matrix-Searches.html) - SR3 workflow for Matrix research, Shadowland/data haven legwork, and host-local file/access-node searches.
...
- [Contact Legwork](/Tech/Matrix/Contact-Legwork.html) - SR3 workflow for contact asks, Friends of Friends, fees, wait times, and Wrong Party risk.
...
- [Buying New Items](/Tech/Matrix/Buying-New-Items.html) - SR3 workflow for Availability, Street Index, contacts, negotiation, legality, wrong-party risk, pickup, and installation status.
...
- [Herrick Huntsville Tooling](NPCs/Herrick-Tooling/) - Herrick NPC behavior, live-session monitoring, voice clips, and Discord support.
- [Herrick GM Control Panel](/NPCs/Herrick-Tooling/GM-Control-Panel.html) - first-effort Discord-native GM button panel for silence/resume, summaries, Herrick action suggestions, saved voice lines, playback, interruption, markers, and closeout prompts.
- [Herrick Tooling Future Planning](/NPCs/Herrick-Tooling/Future-Planning.html) - future planning for table dashboards, closeout workflows, GM controls, onboarding, and VTT companion aids.

## Documentation

- [Mevin Decker Experience Documentation](/Documentation/Mevin-Decker-Experience.html)
- [Mevin Decker Experience Player Manual](/Documentation/Mevin-Decker-Experience-Manual.html)
- [Curtis Drone Shift Documentation](/Documentation/Curtis-Drone-Shift.html)
- [Curtis Drone Shift Work Order Guidelines](/Documentation/Curtis-Drone-Shift-Work-Order-Guidelines.html)
...
- Herrick ingestion workflow: shadowrun-minigame-template/docs/INGESTION_WORKFLOW.md
- WYSIWYG wiki editor persistence plan: [Wiki Editor Persistence](/meta/Wiki-Editor-Persistence.html)
